...
export const Route = createFileRoute("/disclaimer")({
  head: () => ({
    meta: [
      { title: "Disclaimer | ResuMatch" },
      {
        name: "description",
        content:
          "ResuMatch ATS scores are automated estimates, not career or legal advice, and are not affiliated with any applicant tracking system vendor.",
      },
      { property: "og:title", content: "Disclaimer | ResuMatch" },
      {
        property: "og:description",
        content: "Accuracy, no-guarantee and no-affiliation statements for ResuMatch.",
      },
