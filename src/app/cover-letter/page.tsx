...
import { FileText, Sparkles, Copy, Download, Loader2, Lock, ArrowRight, Zap, Check } from "lucide-react";
...
export default function CoverLetterPage() {
  ...
  const generate = useMutation({
    mutationFn: () => generateCoverLetter({ resumeData, jobDescription, tone }),
    onSuccess: () => {
      registerCoverLetter();
