...
import { Check, HelpCircle as HelpIcon, Star, Zap, Shield } from "lucide-react";
...
export default function PricingPage() {
  ...
  const { symbol, proPrice, elitePrice, gateway } = useLocationPricing();
  ...
  const handleUpgrade = async (tier: "pro" | "elite") => {
    ...
    try {
      const order = await createPaymentOrder({ tier, gateway });
