...
<html lang="en">
  <head>
    ...
    <style>
      ...
      pre { text-align: left; background: #fee2e2; color: #991b1b; padding: 1rem; border-radius: 0.375rem; overflow-x: auto; font-family: monospace; font-size: 13px; max-height: 20rem; border: 1px solid #fca5a5; }
    </style>
  </head>
  <body>
    <div class="card">
